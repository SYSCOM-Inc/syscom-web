  ...
  return (
    <div>
      <Seo
        ...
        description="SYSCOM is a Baltimore-based implementation partner for ECM, Tungsten TotalAgility, and IBM FileNet — 40+ years serving government and financial services since 1982."
        path="/"
        jsonLd={ORG_JSON_LD}
      />
      {/* Hero */}
