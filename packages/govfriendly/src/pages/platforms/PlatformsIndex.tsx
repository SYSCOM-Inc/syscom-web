  ...
  return (
    <div>
      <Seo
        ...
        description="SYSCOM implements and supports Tungsten TotalAgility, Kofax Capture, IBM FileNet, IBM Content Manager, Datacap, BAW, Hyland OnBase, and more — 40+ years of ECM and automation expertise."
        path="/platforms"
        jsonLd={JSON_LD}
      />
      ...
      <section className="bg-gradient-to-b from-warm-cream to-warm-bg py-16 sm:py-20" aria-label="Platforms introduction">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="mt-4 text-lg text-slate max-w-3xl leading-relaxed">
            ...
            platforms below — backed by 40+ years of experience and deep IBM and Tungsten Automation
            partnerships.
          </p>
